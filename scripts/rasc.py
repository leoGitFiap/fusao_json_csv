...
# print(f'Nome coluna dados_json: {nome_colunas_json}')
...
# print(f'Nome coluna dados_csv: {nome_colunas_csv}')
...
nome_colunas_csv = get_columns(dados_csv)
# print(f'Nome colunas dados_csv RENOMEADO: {nome_colunas_csv}')
